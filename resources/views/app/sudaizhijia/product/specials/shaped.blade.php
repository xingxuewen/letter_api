...
<div class="specials_box">
    <!--<img src="/view/img/product/specials/banner.png" class="banner"
         onerror="javascript:this.src='/view/img/errors/img_error.png';this.style='background-color:#efefef';"/>-->
    <div class="banner" style="background: #dedede url(/view/img/product/specials/banner1.png) no-repeat 0 0;background-size: 100% 2.87rem;"></div>
        <section class="pro_list">
            <div id="productList">
            	@foreach($data['list'] as $item)
                <div class='product_list' data-productid='{{ $item['platform_product_id'] }}' data-specialtitle='{{ $data['title'] or ''}}' data-title='{{ $item['platform_product_name'] }}'>
                    <dl>
                        <dt>
...
<script src="/view/js/product/specials/shaped.js"></script>
