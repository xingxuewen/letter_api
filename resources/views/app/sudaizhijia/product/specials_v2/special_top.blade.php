...
<head>
    ...
    <link rel="stylesheet" href="/view/css/product/specials_v2/special_top.css"/>
</head>

<body>
<div class="special_top" style="background:{{ $lists['bg_color'] ? '#'.$lists['bg_color'] : '' }}
        url({{ $lists['img'] or '' }}) no-repeat 0 0;background-size:100% auto;">
    <div class="main">
        @if($lists['remark'])
...
<script src="/view/js/product/specials_v2/special_top.js"></script>
