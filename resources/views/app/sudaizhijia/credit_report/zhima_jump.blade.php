...
<body>
    <div class="container"> <img src="/view/img/report/waiting.gif" alt="">
        <div id="href" style="display:none">https://uat.api.sudaizhijia.com/v1/zhima/success</div>
    </div>
    <script>
        setTimeout(function() {
            window.location.href = document.getElementById('href').innerHTML;
        }, 1000)
