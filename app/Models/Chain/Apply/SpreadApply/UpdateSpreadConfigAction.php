 ...
 */
class UpdateSpreadConfigAction extends AbstractHandler
{
    ...
    public function updateSpreadConfig($params = [])
    {
        ...
        //创建流水
        $log = DataFactory::createDataSpreadConfigLog($params);
        //修改总计数
        $clickCount = DataFactory::updateSpreadConfigClickCount($params['configId']);
