...
use App\Services\Core\Shadow\Bank\ShadowBankService;
use App\Services\Core\Spread\SpreadService;
use App\Models\Chain\Shadow\Creditcard\UpdateCreditcardConfigAction;
...
class FetchApplyUrlAction extends AbstractHandler
{
    ...
    private function fetchWebsiteUrl($params)
    {
        ...
        {
            $response = ShadowBankService::i()->toSpreadService($params);
