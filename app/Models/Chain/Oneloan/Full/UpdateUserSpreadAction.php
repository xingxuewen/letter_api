...
use App\Models\Chain\Oneloan\Full\MatchGroupAction;
...
class UpdateUserSpreadAction extends AbstractHandler
{
    ...
    protected $error = array('error' => '一键选贷款full修改信息失败！', 'code' => 1003);
    ...
    private function updateUserSpread($params = [])
    {
        ...
        //存储或修改主键id
        $this->params['spread_id'] = $saveResId ? $saveResId : 0;
        //logInfo('full存完数据结果',['res'=>$saveResId,'data'=>$this->params]);
