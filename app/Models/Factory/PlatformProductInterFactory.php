...
use App\Models\Orm\PlatformProductInter;

class PlatformProductInterFactory extends AbsModelFactory
{
    public static function getAll(array $params = [])
    {
        $query = new PlatformProductInter();
    ...
    {
        return PlatformProductInter::insertGetId($insertData);
    }
