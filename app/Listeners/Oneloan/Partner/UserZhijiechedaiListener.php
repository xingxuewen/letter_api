...
/**
 * 智借车贷
 * Class UserZhijiechedaiListener
 * @package App\Listeners\V1
 */
class UserZhijiechedaiListener extends AppListener
{
    ...
    {
        try {
            $type = UserSpreadFactory::fetchSpreadTypeByNid(SpreadNidConstant::SPREAD_ZHIJIECHEDAI_NID);
    ...
    private function nowPush($spread = [])
    {
        ...
        ZhijiechedaiService::spread($spread,
            function ($res) use ($spread) {
                ...
                ZhijiechedaiCallback::handleRes($res, $spread);
            }, function ($e) {
    ...
    {
        //有车　　　　　　　
        if (in_array($data['car_info'], ['001', '002'])) {
            return true;
        }
