 ...
 */
class UserSpreadYiyangBatchListener extends AppListener
{
    ...
    {
        $spread_nid = SpreadStrategy::getSpreadNid(SpreadNidConstant::SPREAD_YIYANG_NID);
        if ($spread['spread_nid'] == $spread_nid) {
            ...
            YiyangService::register($spread,
                function($res) use ($spread) {
                    ...
                    //处理结果
                    $spread = YiyangCallback::handleRes($res, $spread);
