 ...
 */
class UserSpreadCainiaoBatchListener extends AppListener
{
    ...
    {
        $spread_nid = SpreadStrategy::getSpreadNid(SpreadNidConstant::SPREAD_CAINIAO_NID);
