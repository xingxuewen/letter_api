 ...
 */
class UserSpreadZhanyewangBatchListener extends AppListener
{
    ...
    {
        $spread_nid = SpreadStrategy::getSpreadNid(SpreadNidConstant::SPREAD_ZHANYEWANG_NID);
