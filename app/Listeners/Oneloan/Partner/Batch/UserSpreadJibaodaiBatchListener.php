 ...
 * 吉宝贷
 *
 * Class UserSpreadJibaodaiBatchListener
 * @package App\Listeners\V1\Partner\Batch
 */
class UserSpreadJibaodaiBatchListener extends AppListener
{
    ...
    {
        if ($spread['spread_nid'] == SpreadStrategy::getSpreadNid(SpreadNidConstant::SPREAD_JIBAODAI_NID)) {
