 ...
 */
class UserSpreadYoulinewBatchListener extends AppListener
{
    ...
    {
        $spread_nid = SpreadStrategy::getSpreadNid(SpreadNidConstant::SPREAD_YOULINEW_NID);
