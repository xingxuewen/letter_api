...
namespace App\Services\Core\Oneloan\Youxin\Miaodai\Config;
...
class MiaodaiConfig
{
    ...
    {
        //用户名
        $username = MiaodaiConfig::USERNAME;
        //密码
        $pwd = MiaodaiConfig::PASSWORD;
        //base64加密
    ...
    public static function formatDatas($params = [])
    {
        $datas = [
            ...
            'salary' => isset($params['salary']) ? SpreadStrategy::getSalary($params['salary'])  : '', //月收入
            ...
            'time' => isset($params['time']) ? $params['time'] : '',//申请时间
        ];
