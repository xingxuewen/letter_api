...
namespace App\Services\Core\Oneloan\Hengchang\HengchangConfig;

/**
 *  恒昌配置
 */
class HengchangConfig
{
    //地址
    ...
    const USERNAME = 'sdzj';
    //密码
    const PASSWORD = 'S7XBysbT3TJWJDVs';
    //渠道号
    const QUDAOHAO = 208;
    //加密key
    const JPASSWORD = 'FkwTMLYwfDFiZ5Fr';
    //code
    const HENGCHANG_CODE = 'SDZJ_001';
